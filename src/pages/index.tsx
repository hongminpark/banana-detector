...
const Home: NextPage = () => {
  ...
  return (
    ...
    //     <link rel="icon" href="/favicon.ico" />
    //   </Head>
    //   <main className="black flex min-h-screen flex-col items-center bg-black">
    //     <h1 className="py-4 text-center text-5xl text-[6.5rem] font-extrabold leading-[5.5rem] tracking-tighter text-white">
    //       banana detector
    //     </h1>
    //     <div className="container flex flex-col items-center justify-center gap-24 px-4 py-8 ">
    //       <div className="grid grid-cols-2 gap-4 md:grid-cols-3 xl:grid-cols-4">
    ...
    //           <div key={i} className="md:max-w-xs max-w-xxs">
    //             <img
    //               className="aspect-square w-full object-contain brightness-0 invert filter hover:brightness-100 hover:invert-0"
    //               src={banana}
    //             />
    //             <div className="text-light py-4 text-center font-normal text-white">{`anonymous banana ${
    //               i + 1
    //             }`}</div>
    //           </div>
    //         ))}
